...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--install-theme", dest="install_theme", default="", help="install one theme, requires -d")
    ...
    def _parse_config(self, args=None):
        ...
        keys = ['gevent_port', 'http_interface', 'http_port', 'longpolling_port', 'http_enable', 'x_sendfile',
                ...
                'log_db_level', 'geoip_database', 'dev_mode', 'shell_interface', 'uninstall', 'install_theme',
